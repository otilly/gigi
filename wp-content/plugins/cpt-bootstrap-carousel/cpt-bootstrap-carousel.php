...
function cptbc_frontend($atts){
	...
	if(count($images) > 0){
		ob_start();
		?>
		<?php if($atts['category'] == 'press'){  ?>
		<div class="container press-carousel">
			<div class="row">
		<?php } ?>
					...
					<?php if($atts['category'] == 'press'){  ?>
						<div class="item active ">
							<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
								<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Doloremque, maxime accusantium vero a ipsum recusandae adipisci ipsa nemo ad magnam voluptatum neque quae. Voluptatum, velit sed quia neque modi explicabo?</p>
							</div>
						</div>
					<?php } ?>
					<?php foreach ($images as $key => $image) { ?>
